...
public class FullscreenActivity extends AppCompatActivity {
    ...
    /**
     * configuration for Breinify REST call
     */
    ...
    private void testLogin() {
         ...
         */
        final String breinCategoryType = BreinCategoryType.HOME;

        /**
         * Contains the BreinActivityType
         */
        final String breinActivityType = BreinActivityType.LOGIN;
